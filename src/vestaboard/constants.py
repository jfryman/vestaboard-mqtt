...
CHAR_CODE_MAP = {
    ...
    **{i: chr(ord("A") + i - 1) for i in range(1, 27)},  # A-Z (1-26)
    ...
    48: "=",
    49: ";",
    50: ":",  # punctuation continued
    52: "'",
    53: '"',
    54: "%",
    55: ",",
    56: ".",
    59: "/",  # punctuation continued
    60: "?",
    62: "♥",  # question mark, heart (Note) / degree (Flagship)
    # Color codes
    63: "🟥",
    64: "🟧",
    65: "🟨",
    66: "🟩",
    67: "🟦",
    68: "🟪",  # red, orange, yellow, green, blue, violet
    69: "⬜",
    70: "⬛",
    71: "⬛",  # white, black, filled
}
...
TEXT_TO_CODE_MAP = {
    ...
    **{chr(ord("A") + i): i + 1 for i in range(26)},  # A-Z -> 1-26
    ...
    "?": 60,
    "♥": 62,
    "❤": 62,  # question mark, heart (both ♥ and ❤ map to same code)
